...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private OprStandaloneBase[] cacheOprStandaloneBase;
		public OprStandaloneBase OprStandaloneBase(string s_CustomSessionStart, string s_OpeningRangePeriod, string s_PreSessionStart, string s_PreSessionEnd, double percentage1, double percentage2, double percentage3, double percentage4, OprSessionType sessionType, OprTimeZones customTZSelector, OprPreSessionType preSessionType, OprTimeZones preSessionTZSelector, OprBandType bandType, OprSessionTypeS sessionType13, OprTimeZonesS customTZSelector14, OprPreSessionTypeS preSessionType15, OprTimeZonesS preSessionTZSelector16, OprBandTypeS bandType17)
		{
			return OprStandaloneBase(Input, s_CustomSessionStart, s_OpeningRangePeriod, s_PreSessionStart, s_PreSessionEnd, percentage1, percentage2, percentage3, percentage4, sessionType, customTZSelector, preSessionType, preSessionTZSelector, bandType, sessionType, customTZSelector, preSessionType, preSessionTZSelector, bandType);
		}

		public OprStandaloneBase OprStandaloneBase(ISeries<double> input, string s_CustomSessionStart, string s_OpeningRangePeriod, string s_PreSessionStart, string s_PreSessionEnd, double percentage1, double percentage2, double percentage3, double percentage4, OprSessionType sessionType, OprTimeZones customTZSelector, OprPreSessionType preSessionType, OprTimeZones preSessionTZSelector, OprBandType bandType, OprSessionTypeS sessionType13, OprTimeZonesS customTZSelector14, OprPreSessionTypeS preSessionType15, OprTimeZonesS preSessionTZSelector16, OprBandTypeS bandType17)
		{
			if (cacheOprStandaloneBase != null)
				for (int idx = 0; idx < cacheOprStandaloneBase.Length; idx++)
					if (cacheOprStandaloneBase[idx] != null && cacheOprStandaloneBase[idx].S_CustomSessionStart == s_CustomSessionStart && cacheOprStandaloneBase[idx].S_OpeningRangePeriod == s_OpeningRangePeriod && cacheOprStandaloneBase[idx].S_PreSessionStart == s_PreSessionStart && cacheOprStandaloneBase[idx].S_PreSessionEnd == s_PreSessionEnd && cacheOprStandaloneBase[idx].Percentage1 == percentage1 && cacheOprStandaloneBase[idx].Percentage2 == percentage2 && cacheOprStandaloneBase[idx].Percentage3 == percentage3 && cacheOprStandaloneBase[idx].Percentage4 == percentage4 && cacheOprStandaloneBase[idx].SessionType == sessionType && cacheOprStandaloneBase[idx].CustomTZSelector == customTZSelector && cacheOprStandaloneBase[idx].PreSessionType == preSessionType && cacheOprStandaloneBase[idx].PreSessionTZSelector == preSessionTZSelector && cacheOprStandaloneBase[idx].BandType == bandType && cacheOprStandaloneBase[idx].SessionType == sessionType && cacheOprStandaloneBase[idx].CustomTZSelector == customTZSelector && cacheOprStandaloneBase[idx].PreSessionType == preSessionType && cacheOprStandaloneBase[idx].PreSessionTZSelector == preSessionTZSelector && cacheOprStandaloneBase[idx].BandType == bandType && cacheOprStandaloneBase[idx].EqualsInput(input))
						return cacheOprStandaloneBase[idx];
			return CacheIndicator<OprStandaloneBase>(new OprStandaloneBase(){ S_CustomSessionStart = s_CustomSessionStart, S_OpeningRangePeriod = s_OpeningRangePeriod, S_PreSessionStart = s_PreSessionStart, S_PreSessionEnd = s_PreSessionEnd, Percentage1 = percentage1, Percentage2 = percentage2, Percentage3 = percentage3, Percentage4 = percentage4, SessionType = sessionType, CustomTZSelector = customTZSelector, PreSessionType = preSessionType, PreSessionTZSelector = preSessionTZSelector, BandType = bandType, SessionType = sessionType, CustomTZSelector = customTZSelector, PreSessionType = preSessionType, PreSessionTZSelector = preSessionTZSelector, BandType = bandType }, input, ref cacheOprStandaloneBase);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.OprStandaloneBase OprStandaloneBase(string s_CustomSessionStart, string s_OpeningRangePeriod, string s_PreSessionStart, string s_PreSessionEnd, double percentage1, double percentage2, double percentage3, double percentage4, OprSessionType sessionType, OprTimeZones customTZSelector, OprPreSessionType preSessionType, OprTimeZones preSessionTZSelector, OprBandType bandType, OprSessionTypeS sessionType13, OprTimeZonesS customTZSelector14, OprPreSessionTypeS preSessionType15, OprTimeZonesS preSessionTZSelector16, OprBandTypeS bandType17)
		{
			return indicator.OprStandaloneBase(Input, s_CustomSessionStart, s_OpeningRangePeriod, s_PreSessionStart, s_PreSessionEnd, percentage1, percentage2, percentage3, percentage4, sessionType, customTZSelector, preSessionType, preSessionTZSelector, bandType, sessionType, customTZSelector, preSessionType, preSessionTZSelector, bandType);
		}
